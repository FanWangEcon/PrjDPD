...
#' to consider (also overall percentiles)
#' @param ar_fl_ratio_upper array of percentiles, should be included in \input{ar_fl_percentiles} that
#' will be in the numerators of relative percentile ratios
#' @param ar_fl_ratio_lower array of percentiles, should be included in \input{ar_fl_percentiles} that
#' will be in the denominator of relative percentile ratios
...
#' @author fan wang, \url{http://climateinequality.github.io}
#'
#' @return an array of tax-liabilities for particular kids count and martial
#'   status along an array of income levels
#' @references
#' \url{https://climateinequality.github.io/prjenvdemo/articles/fv_rda_simu_loc_demo.html}
#' @export
