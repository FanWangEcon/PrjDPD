...
spt_results <- "PIRE/team/xiuqi_yang/PM2.5_tables/final_21group_output/ineq_demo_loc"
...
stv_grp_demo <- "edu_x_mig3"
arv_label_demo <- c("edu_continuous", "edu_categorical", "migration_status3")

# 6. Variable names for location names -----
str_prefix_loc <- ""
stv_key_loc <- "location_key"
stv_key_loc_agg <- "Gbcounty"
stv_grp_loc <- "urban_rural"
arv_label_loc <- c("urban_rural")
